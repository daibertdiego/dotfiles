-- lvim.builtin.which_key.mappings["<F5>"] = { "<cmd>lua require'dap'.step_back()<cr>", "Step Back" }
-- lvim.builtin.which_key.mappings["<F7>"] = { "<cmd>lua require'dap'.step_into()<cr>", "Step Into" }
-- lvim.builtin.which_key.mappings["<F8>"] = { "<cmd>lua require'dap'.step_over()<cr>", "Step over" }
-- lvim.builtin.which_key.mappings["<F9>"] = { "<cmd>lua require'dap'.run_to_cursor()<cr>", "Run To Cursor" }

local opts = { noremap = true, silent = true }
vim.api.nvim_set_keymap("n", "<F5>", "<cmd>lua require'dap'.step_back()<cr>", opts)
...
vim.api.nvim_set_keymap("n", "<F9>", "<cmd>lua require'dap'.run_to_cursor()<cr>", opts)
...
lvim.builtin.which_key.mappings["dr"] = { "<cmd>lua require'dap'.continue()<cr>", "Run" }
lvim.builtin.which_key.mappings["dD"] = { "<cmd>lua require'dap'.disconnect()<cr>", "Disconnect" }
lvim.builtin.which_key.mappings["dg"] = { "<cmd>lua require'dap'.session()<cr>", "Get Session" }
lvim.builtin.which_key.mappings["do"] = { "<cmd>lua require'dap'.step_out()<cr>", "Step Out" }
lvim.builtin.which_key.mappings["dp"] = { "<cmd>lua require'dap'.pause()<cr>", "Pause" }
lvim.builtin.which_key.mappings["dt"] = { "<cmd>lua require'dap'.repl.toggle()<cr>", "Toggle Repl" }
lvim.builtin.which_key.mappings["ds"] = { "<cmd>lua require'dap'.continue()<cr>", "Start" }
